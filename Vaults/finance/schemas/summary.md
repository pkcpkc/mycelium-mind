...
| `times`             | Array  | **Required** | Mentioned dates and events (e.g. `[{date: "2026-05-03", title: "Tesla AI Day"}]`).    |
| `relationships`     | Array  | **Required** | Interpersonal relations (e.g. `[{personA: "A", relation: "teaches", personB: "B"}]`). |
