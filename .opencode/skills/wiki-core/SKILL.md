...
- **Correct Format:** `([source](assets/YYYY-MM-DD/filename.md))` or `([source](file:///path/to/file.md))`.
- **Incorrect Formats:**
  - `([source](<"assets/YYYY-MM-DD/filename.md>"))` (contains quotes and brackets)
  - `([source](<assets/YYYY-MM-DD/filename.md>))` (contains brackets)
  - `[[assets/YYYY-MM-DD/filename.md|source]]` (do not use Obsidian wikilinks for source attributions)
