...
---
[YAML frontmatter matching the Schema Specification above. Ensure type is "Times", title is "$VALUE", status is "stable", generated is { by: "agentic-compiler", at: "$TIMESTAMP" }, and other fields match the schema.]
---
# $VALUE
